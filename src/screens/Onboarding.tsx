...
export default function Onboarding() {
  ...
  if (showRecovery) {
    return (
      <SignIn
        recoveryOnly
        onStartFresh={async () => setShowRecovery(false)}
        ...
        {step === 1 && (
          <OnboardingStep key={1}>
            ...
            <div className="onboarding-actions">
              <PrimaryButton onClick={() => setStep(2)}>start haunting</PrimaryButton>
              <PrimaryButton variant="ghost" onClick={() => setShowRecovery(true)}>
                use recovery code
              </PrimaryButton>
            </div>
          </OnboardingStep>
